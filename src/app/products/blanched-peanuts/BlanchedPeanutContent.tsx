...
import blanchedPeanutProductImage from "@/assets/images/productImg/BlanchedPeanutProduct.webp";
  ...
  return (
    <Box sx={{ bgcolor: theme.palette.background.default, pb: 8 }}>
      <Container component="section" aria-label="Product Introduction" maxWidth="lg" sx={{ mt: { xs: 3, md: 5 } }}>
        <Grid container spacing={{ xs: 4, md: 4 }} alignItems="center" justifyContent="space-between">
          <Grid item xs={12} md={6} sx={{ width: { md: '48%' } }}>
            ...
            >
              <Image
                src={blanchedPeanutProductImage}
                alt="Blanched Peanuts Product"
                fill
                style={{ 
                  objectFit: 'cover',
      ...
      <Container component="section" aria-label="Other Products" maxWidth="lg" sx={{ mt: { xs: 6, md: 8 } }}>
        <ProductCarousel currentProductPath="/products/blanched-peanuts" />
      </Container>
...
export default BlanchedPeanutContent; 