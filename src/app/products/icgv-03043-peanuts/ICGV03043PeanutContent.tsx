...
import icgv15099ProductImage from '@/assets/images/productImg/ICGV15099Product.webp';
  ...
  return (
    <Box sx={{ bgcolor: theme.palette.background.default, pb: 8 }}>
      ...
      <Container component="section" aria-label="Product Introduction" maxWidth="lg" sx={{ mt: { xs: 3, md: 5 } }}>
        ...
        >
          ...
          <Grid item xs={12} md={6} sx={{ width: { md: '48%' } }}>
            ...
            >
              <Image
                src={icgv15099ProductImage}
                alt="ICGV-15099 Premium High Oleic Peanuts"
                fill
                style={{ 
                  objectFit: 'cover',
          ...
          <Grid item xs={12} md={6} sx={{ width: { md: '48%' } }}>
            ...
            >
              ICGV 03043: Premium High Oleic Peanuts for Health-Focused & Export-Grade Applications
            </Typography>
            <Typography 
              variant="body1" 
              sx={{ 
            ...
            >
              <span style={{ fontWeight: 700 }}> ICGV 03043 is a cutting-edge, high-oleic peanut variety </span>
        ...
        >
          At Balaji Exports, we offer top-quality ICGV 03043 high oleic peanuts, processed in hygienic facilities with full traceability and global export compliance. 
      ...
      <Container component="section" aria-label="Other Products" maxWidth="lg" sx={{ mt: { xs: 6, md: 8 } }}>
        <ProductCarousel currentProductPath="/products/icgv-03043-peanuts" />
      </Container>
      {/* Breadcrumbs */}
...
const ProductSpecifications = () => {
  ...
  const specSections = {
    qualities: {
      ...
      items: [
        { name: "Size", value: "40/50, 42/50, 50/60, 60/70, 70/80, 80/90 (based on harvest and grade)" },
