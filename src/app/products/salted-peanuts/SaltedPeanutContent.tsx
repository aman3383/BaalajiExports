...
import saltedPeanutProductImage from '@/assets/images/productImg/SaltedPeanutProduct.webp';
    ...
    <Box sx={{ width: '100%', maxWidth: '6xl', mx: 'auto', px: 4, py: { xs: 6, md: 4 }, mb: { xs: -2, md: -3 } }}>
      <Box sx={{ textAlign: 'center', mb: 3 }}>
        ...
        <Typography variant="body1" sx={{ color: theme.palette.secondary.main, fontSize: '1rem', maxWidth: '2xl', mx: 'auto', fontFamily: 'Inter, sans-serif' }}>
          Our salted peanuts meet the highest quality standards for international markets
        </Typography>
      </Box>
...
const SaltedPeanutContent: React.FC = () => {
  const theme = useTheme();
  return (
    <Box sx={{ bgcolor: theme.palette.background.default, pb: 8 }}>
      ...
      <Container component="section" aria-label="Product Introduction" maxWidth="lg" sx={{ mt: { xs: 3, md: 5 } }}>
        <Grid container spacing={{ xs: 4, md: 4 }} alignItems="center" justifyContent="space-between">
          ...
          <Grid item xs={12} md={6} sx={{ width: { md: '48%' } }}>
            ...
            >
              <Image
                src={saltedPeanutProductImage}
                alt="Premium Salted Peanuts"
                fill
                style={{ 
                  objectFit: 'cover',
          ...
          {/* Right side for text */}
          <Grid item xs={12} md={6} sx={{ width: { md: '48%' } }}>
            <Typography variant="h3" component="h3" gutterBottom sx={{ fontFamily: 'Lato, sans-serif', fontWeight: 700, color: theme.palette.primary.main, fontSize: { xs: '1.75rem', sm: '2rem', md: '2.25rem' }, position: 'relative', pb: 2, '&:after': { content: '""', position: 'absolute', bottom: 0, left: 0, width: '80px', height: '4px', backgroundColor: theme.palette.primary.main, borderRadius: '2px' } }}>Premium Quality | Roasted & Seasoned | Ready to Eat</Typography>
            <Typography variant="body1" sx={{ my: 3, fontFamily: 'Inter, sans-serif', color: theme.palette.secondary.main, fontSize: { xs: '0.95rem', md: '1rem' }, lineHeight: 1.8 }}>Balaji Exports presents premium Salted Peanuts, carefully roasted and seasoned to perfection for a rich, crunchy taste. Sourced from our own farms in India, these peanuts are processed in our state-of-the-art facility using hygienic, food-grade methods. Ideal for snacking and food applications, our salted peanuts are available in bulk and private label packaging to meet global market demands.</Typography>
            <Typography variant="body1" sx={{ mb: 3, fontFamily: 'Inter, sans-serif', color: theme.palette.secondary.main, fontSize: { xs: '0.95rem', md: '1rem' }, lineHeight: 1.8 }}>We use Java, Bold, or Redskin peanut varieties, as preferred by our clients, and strictly follow international food safety standards. Whether you're a snack brand, wholesaler, or importer, Balaji Exports ensures quality, consistency, and flavor in every batch.</Typography>
            <Box sx={{ mb: 3, maxWidth: '500px' }}>
              <CertificationsCarousel height="60px" showDots={false} />
            </Box>
          </Grid>
        </Grid>
        <Typography variant="body1" sx={{ my: 4, fontFamily: 'Inter, sans-serif', color: theme.palette.secondary.main, fontSize: { xs: '0.95rem', md: '1rem' }, lineHeight: 1.8, textAlign: { xs: 'left', md: 'center' }, maxWidth: '900px', mx: 'auto' }}>Salted peanuts are famous for their uniform kernel size, elongated oval shape, and consistent roasting characteristics. Their outstanding quality makes them ideal for peanut butter manufacturing, confectionery applications, and snack production. As one of the leading peanut exporters from India, we supply bulk peanuts for sale to markets across the UAE, Europe, USA, Russia, Vietnam, and Africa, meeting the growing groundnut export demand worldwide.</Typography>
      </Container>
      ...
      <Box component="section" aria-label="Product Applications" sx={{ background: `linear-gradient(135deg, ${theme.palette.primary.main} 0%, ${theme.palette.primary.dark} 100%)`, color: theme.palette.customColors.darkGold, mt: { xs: 8, md: 12 }, py: { xs: 6, md: 8 }, borderRadius: { md: '100px 0 100px 0' }, position: 'relative', overflow: 'hidden' }}>
        ...
        <Container maxWidth="lg">
          ...
          <Typography variant="body1" sx={{ mt: 5, mb: 4, fontFamily: 'Inter, sans-serif', fontSize: { xs: '1rem', md: '1.1rem' }, color: theme.palette.customColors.lightGold, textAlign: 'center', maxWidth: '850px', mx: 'auto', lineHeight: 1.8 }}>Our premium salted peanuts are versatile and perfect for various commercial applications:</Typography>
          <Box sx={{ maxWidth: '800px', mx: 'auto', mt: 4, px: 3 }}>
            {[
              { title: "Snack Industry", icon: "🍿", desc: "Perfect for retail packs, trail mix, and snack bars with consistent flavor and crunch." },
              { title: "Office & Airline Catering", icon: "✈️", desc: "Ideal portion-controlled snacks for corporate and travel hospitality services." },
              { title: "Retail & Supermarkets", icon: "🛒", desc: "Available in private label packaging for retail brands and supermarket chains." },
              { title: "Bar Snacks & Foodservice", icon: "🍺", desc: "The perfect accompaniment to beverages in bars, restaurants and hospitality settings." },
              { title: "Bulk Exports", icon: "🌍", desc: "Available in bulk packaging for international repackaging operations." }
            ].map((item, index) => (
          ...
          <Typography variant="body1" sx={{ mt: 4, fontFamily: 'Inter, sans-serif', fontSize: { xs: '1rem', md: '1.05rem' }, color: theme.palette.customColors.lightGold, textAlign: 'center', maxWidth: '850px', mx: 'auto', fontStyle: 'italic', p: 2, borderRadius: 2, background: 'rgba(255,255,255,0.07)' }}>Our salted peanuts' consistent quality ensures reliable performance across all these applications, making them a preferred choice for businesses requiring premium ingredients.</Typography>
        </Container>
      </Box>
        ...
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-between', gap: { xs: 4, md: '4%' } }}>
          ...
          <Box sx={{ width: { xs: '100%', md: '48%' } }}>
            <Paper elevation={3} sx={{ borderRadius: 3, background: `linear-gradient(135deg, ${theme.palette.primary.main} 0%, ${theme.palette.primary.dark || '#1a3526'} 100%)`, transition: 'transform 0.3s, box-shadow 0.3s', '&:hover': { transform: 'translateY(-6px)', boxShadow: '0px 10px 20px rgba(0,0,0,0.2)' } }}>
              {[
                { title: "Crunchy & Flavorful", description: "Dry or oil roasted with optimal salt balance for perfect taste and texture." },
                { title: "100% Natural", description: "No preservatives, no added colors - just pure peanut goodness with salt." },
                { title: "Customizable Size & Salt Levels", description: "Tailored to your specific market needs and consumer preferences." },
                { title: "EU-Standard Aflatoxin Control", description: "<10 ppb, lab tested to ensure safety and compliance with global standards." },
                { title: "Vacuum & Retail Packaging", description: "Available in various packaging options for extended shelf life." },
                { title: "Organic Farming Practices", description: "Grown without pesticides using sustainable agricultural methods." }
      ...
      <Container component="section" aria-label="Why Choose Our Products" maxWidth="lg" sx={{ my: { xs: 6, md: 10 }, px: { xs: 3, md: 4 } }}>
        <Grid container spacing={4}>
          <Grid item xs={12} md={8} sx={{ mx: 'auto' }}>
            <Typography variant="h3" component="h2" sx={{ fontFamily: 'Lato, sans-serif', fontWeight: 700, color: theme.palette.primary.main, mb: 4, textAlign: { xs: 'left', md: 'center' }, fontSize: { xs: '1.6rem', sm: '1.8rem', md: '2rem' } }}>Why Choose Our Salted Peanuts?</Typography>
            <Typography variant="body1" component="p" sx={{ mb: 3, fontFamily: 'Inter, sans-serif', color: theme.palette.secondary.main, lineHeight: 1.8, fontSize: { xs: '0.95rem', md: '1rem' }, position: 'relative', pl: 3, '&:before': { content: '""', position: 'absolute', left: 0, top: '8px', width: '8px', height: '8px', borderRadius: '50%', backgroundColor: theme.palette.primary.main } }}>Food industries requiring consistent size and flavor for premium products and international applications choose our salted peanuts for reliable quality.</Typography>
            ...
            <Typography variant="body1" component="p" sx={{ fontFamily: 'Inter, sans-serif', color: theme.palette.secondary.main, lineHeight: 1.8, fontSize: { xs: '0.95rem', md: '1rem' }, position: 'relative', pl: 3, '&:before': { content: '""', position: 'absolute', left: 0, top: '8px', width: '8px', height: '8px', borderRadius: '50%', backgroundColor: theme.palette.primary.main } }}>Partner with Balaji Exports, the top peanut export company in India, and source the highest quality salted peanuts for your global needs. Trust our experience, quality, and commitment to deliver the best from India's fertile fields to your business.</Typography>
            <Box sx={{ textAlign: 'center', mt: 6 }}>
              <Button variant="contained" component={Link} href="/contact" size="large" aria-label="Request a quotation for Salted Peanuts" sx={{ bgcolor: theme.palette.primary.main, fontFamily: 'Inter, sans-serif', px: { xs: 4, md: 5 }, py: { xs: 1, md: 1.5 }, fontSize: { xs: 15, md: 16 }, fontWeight: 600, boxShadow: '0 4px 14px rgba(0,0,0,0.2)', borderRadius: '6px', transition: 'all 0.3s ease', '&:hover': { bgcolor: theme.palette.secondary.main, transform: 'translateY(-3px)', boxShadow: '0 6px 20px rgba(0,0,0,0.3)' } }}>Request Quotation</Button>
            </Box>
          </Grid>
        </Grid>
      </Container>
      ...
      {/* Product Carousel */}
      <ProductCarousel currentProductPath="/products/salted-peanuts" />
      ...
      <Container sx={{ mb: 4, mt: 8 }}>
        <nav aria-label="breadcrumb">
          <Typography variant="body2" color="text.secondary" sx={{ fontFamily: 'Inter, sans-serif', display: 'flex', flexWrap: 'wrap', gap: 1 }}>
            ...
            <span style={{ color: theme.palette.primary.main }}>Salted Peanuts</span>
          </Typography>
        </nav>
      </Container>
    </Box>
...
export default SaltedPeanutContent; 